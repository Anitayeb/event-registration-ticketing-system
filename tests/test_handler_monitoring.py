...
def _invoke(module_name, event):
    ...
    Examples:
        registerParticipants -> registerParticipants.app
        getEvents            -> getEvents.app
        getRegistrations     -> getRegistrations.app
        cancelRegistrations  -> cancelRegistrations.app
    """
...
class TestRegisterParticipants:
    ...
    def test_full_event_returns_409(
        self,
        dynamodb_tables,
    ):
    ...
    def test_valid_phone_is_stored(
        self,
        dynamodb_tables,
    ):
    ...
    def test_invalid_event_id_format_returns_400(
        self,
        dynamodb_tables,
    ):
